...
export const useToggle = (arr: any[], value?: any) => {
...
export const useBoolean = (value:boolean = false) => {   
    const [boolean, toggleBoolean] = useToggle([true, false], value)
...
export const useLocalStorage = (hash: string, defaultValue?: string) => {
    ...
    const updateInLS = useCallback((state: any) => window.localStorage.setItem(hash, state), [])
